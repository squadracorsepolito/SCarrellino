...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, CH_EN_CMD_GPIO_OUT_Pin|STAT1_LED_GPIO_OUT_Pin|WARN_LED_GPIO_OUT_Pin|STAT3_LED_GPIO_OUT_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = CH_EN_CMD_GPIO_OUT_Pin|STAT1_LED_GPIO_OUT_Pin|WARN_LED_GPIO_OUT_Pin|STAT3_LED_GPIO_OUT_Pin;
